...
/// Theme collections
///
/// Config how the application theme will be
class ThemeCollections {
  ...
  static const FlexSchemeColor LightThemeColors = FlexSchemeColor(
    ...
    errorContainer: Color(0xFF8F4B17), //
  );
  static const FlexSchemeColor DarkThemeColors = FlexSchemeColor(
    ...
    errorContainer: Color(0xFF813800), //
  );
